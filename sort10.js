function autoSortAndValidate() {
    var correctOrder = [a1, a2, a3, a4, a5, a6, a7, a8, a9, a10];
...
function validateSorting() {
    ...
    if (answer[0] === a1 && answer[1] === a2 && answer[2] === a3 && answer[3] === a4 && answer[4] === a5 && answer[5] === a6 && answer[6] === a7 && answer[7] === a8 && answer[8] === a9 && answer[9] === a10) {
